                            ...
                            <div class="user-left">
                                <div class="center">
                                    ...
                                    <div data-provides="fileupload" class="fileupload fileupload-new">
                                        <div class="user-image">
                                            <div class="fileupload-new thumbnail"><?php echo $this->Html->image([
                                                        'controller' => 'docentes',
                                                        'action'     => 'mostrar_foto',
                                                        $docente['Docente']['id'],
                                                ], [
                                            ...
                                            <div class="user-image-buttons">
                                                ...
                                                <a data-dismiss="fileupload"
                                                   class="btn fileupload-exists btn-bricky btn-sm" href="#">
                                ...
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tr>
                                        <td>Nacionalidade</td>
                                        <td>
                                            <span class="label label-sm label-info"><?php echo h($docente['Entidade']['PaisNascimento']['name']); ?></span>
                                        </td>
                                        <td><a class="show-tab" href="#panel_edit_account"><i
                                                        class="fa fa-pencil edit-user-info"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td>Naturalidade</td>
                                        <td><?php echo h($docente['Entidade']['naturalidade']); ?>
                                            - <?php echo h($docente['Entidade']['ProvinciaNascimento']['name']); ?></td>
                                        <td><a class="show-tab" href="#panel_edit_account"><i
                                                        class="fa fa-pencil edit-user-info"></i></a></td>
                                    </tr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group connected-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="yyyy" id="yyyy"
                                                   placeholder="1982">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <label class="radio-inline">
                                            <div class="iradio_minimal-grey" style="position: relative;"><input
                                                        type="radio" id="gender_female" name="gender" value=""
                                                        class="grey"
                                                ...
                                                <ins class="iCheck-helper"
                                                     style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;"></ins>
                                            </div>
                                            Female
                                        </label>
                                        <label class="radio-inline">
                                            <div class="iradio_minimal-grey checked" style="position: relative;"><input
                                                        type="radio" checked="checked" id="gender_male" name="gender"
                                                        value="" class="grey"
                                                        style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;">
                                                <ins class="iCheck-helper"
                                                     style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;"></ins>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city" name="city" data-placement="top" title=""
                                                   data-rel="tooltip"
                                                   data-original-title="We'll display it when you write reviews"
                                                   placeholder="London (UK)" class="form-control tooltips">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div data-provides="fileupload" class="fileupload fileupload-new">
                                        <div style="width: 150px; height: 150px;" class="fileupload-new thumbnail"><img
                                                    alt="" src="assets/images/avatar-1-xl.jpg">
                                        </div>
                                        ...
                                        <div class="user-edit-image-buttons">
                                            ...
                                            <a data-dismiss="fileupload" class="btn fileupload-exists btn-light-grey"
                                               href="#">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                    <a data-original-title="Edit" data-placement="top" class="btn btn-teal tooltips"
                                       href="#"><i class="fa fa-edit"></i></a>
                                    <a data-original-title="Share" data-placement="top" class="btn btn-green tooltips"
                                       href="#"><i class="fa fa-share"></i></a>
                                    <a data-original-title="Remove" data-placement="top" class="btn btn-bricky tooltips"
                                       href="#"><i class="fa fa-times fa fa-white"></i></a>
                                </div>
